...
export class RsvpService {
  ...
  // Обновление по коду (все поля опциональны)
  static async updateByCode(code: string, update: {
    name?: string;
    email?: string;
    attending?: boolean;
    plusOne?: number;
    ...
    return prisma.rsvp.update({
      ...
      data: {
        ...
        plusOne: update.plusOne,
        alcohol: update.alcohol,
